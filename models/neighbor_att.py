...
class Wcompute(nn.Module):
    ...
    def forward(self, x, W_id):
        ...
        if self.activation == 'softmax':
            ...
            # --- ABLATION: NO SPARSE EDGE FILTERING ---
            # In the original code, a kthvalue threshold was computed to drop a percentage 'p' of edges.
            # We completely remove that sparsification step and just apply dense softmax directly.
...
@register('neighbor_att')
class neighbor_att(nn.Module):
